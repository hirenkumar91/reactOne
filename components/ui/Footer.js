      ...
      */}
      ...
      <div className={styles.footerLinks}>
        ...
        <ul className={styles.footerList}>
          ...
          {/* It should accept the following props: url, title, icon */}
          {/* For the icons, you can download 1-2 social media icons for testing and put them in the /public/socialmedia/ folder */}
        </ul>
      </div>
    </footer>
  );
